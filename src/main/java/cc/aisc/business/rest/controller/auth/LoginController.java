...
import cc.aisc.config.auth.CurrentUser;
import cc.aisc.config.auth.JwtTokenService;
...
public class LoginController {
    ...
    public Response login(@RequestBody final AuthenticationRequest request, Device device) throws Exception{
        ...
        // Return the token
        return new Response(new ResponseBody(200000, true, false, "登陆成功", token), HttpStatus.OK);
/*
