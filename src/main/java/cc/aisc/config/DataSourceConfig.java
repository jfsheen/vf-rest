...
@MapperScan(basePackages = {"cc.aisc.business.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        datasource.setMaxActive(Integer.parseInt(rpr.getProperty("max-active")));
        datasource.setMaxWait(Integer.parseInt(rpr.getProperty("max-wait")));
        datasource.setInitialSize(Integer.parseInt(rpr.getProperty("initial-size")));
        ...
        datasource.setMinIdle(Integer.parseInt(rpr.getProperty("min-idle")));
