...
import cc.aisc.config.auth.JwtAuthenticationFilter;
...
/*                .authenticationProvider(jwtAuthenticationProvider())*/
    ...
    public AuthenticationEntryPoint unauthorizedEntryPoint() {
        return (request, response, authException) -> {
            ...
            Response resp = new Response(new ResponseBody(400001,true, false, "未登录",null), HttpStatus.UNAUTHORIZED);
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/cntr/**","/acnt/**", "/auth/**", "/sys/**","/tspt/**","/rut/**","/corp/**","/veh/**","/login").permitAll()
